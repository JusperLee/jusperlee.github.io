...
[A Semantically Consistent Dataset for Data-Efficient Query-Based Universal Sound Separation](https://arxiv.org/abs/2601.22599) **Kai Li\***, Jintao Cheng*, Chang Zeng, Zijun Yan, Helin Wang, Zixiong Su, Bo Zheng, Xiaolin Hu. **ICML 2026. Seoul, South Korea.**

- Hive proposes a semantically consistent benchmark and pipeline for data-efficient query-based universal sound separation, featuring ontology-aware preprocessing, semantic-acoustic alignment, and super-resolution standardization.

- [![Demo-Page](https://img.shields.io/badge/Demo_Page-Online-brightgreen)](https://cslikai.cn/Hive) \| <a href="https://github.com/JusperLee/Hive"><img src="https://img.shields.io/github/stars/JusperLee/Hive?style=social&amp;label=Code+Stars" alt=""></a> \| [![Hive Dataset](https://img.shields.io/badge/Huggingface-Hive--ALL-orange?logo=huggingface)](https://huggingface.co/datasets/JusperLee/Hive-ALL) \| [![FlowSep-hive](https://img.shields.io/badge/Huggingface-FlowSep--hive-orange?logo=huggingface)](https://huggingface.co/ShandaAI/FlowSep-hive) \| [![AudioSep-hive](https://img.shields.io/badge/Huggingface-AudioSep--hive-orange?logo=huggingface)](https://huggingface.co/ShandaAI/AudioSep-hive)

</div>
</div>

<div class='paper-box'><div class='paper-box-image'><div><div class="badge">ICML 2026</div><img src='./images/dvpd.png' alt="sym" width="100%"></div></div>
<div class='paper-box-text' markdown="1">

[Dual-View Predictive Diffusion: Lightweight Speech Enhancement via Spectrogram-Image Synergy](https://arxiv.org/abs/2602.00568) Ke Xue, Rongfei Fan, **Kai Li**, Shanping Yu, Puning Zhao, Jianping An. **ICML 2026. Seoul, South Korea.**

- DVPD combines a Frequency-Adaptive Non-uniform Compression encoder, a Lightweight Image-based Spectro-Awareness module, and a training-free lossless boost strategy to deliver high-quality speech enhancement at a small footprint.

- [![Demo-Page](https://img.shields.io/badge/Demo_Page-Online-brightgreen)](https://dvpd-demo.vercel.app/)

</div>
</div>

<div class='paper-box'><div class='paper-box-image'><div><div class="badge">CVPR 2026</div><img src='./images/avsr-vc.png' alt="sym" width="100%"></div></div>
<div class='paper-box-text' markdown="1">

[When AVSR Meets Video Conferencing: Dataset, Degradation, and the Hidden Mechanism Behind Performance Collapse](https://arxiv.org/abs/2603.22915) Yihuan Huang, Jun Xue, Liu Jiajun, Daixian Li, Tong Zhang, Zhuolin Yi, Yanzhen Ren, **Kai Li**. **CVPR 2026. Denver, USA.**

- Introduces the MLD-VC dataset and analyzes how transmission distortions and hyper-expression in hindered communication settings drive AVSR performance collapse in real video-conferencing scenarios.

- [![MLD-VC Dataset](https://img.shields.io/badge/Huggingface-MLD--VC-orange?logo=huggingface)](https://huggingface.co/datasets/nccm2p2/MLD-VC)

</div>
</div>

<div class='paper-box'><div class='paper-box-image'><div><div class="badge">ICLR 2026</div><img src='./images/audiotrust.png' alt="sym" width="100%"></div></div>
<div class='paper-box-text' markdown="1">

[AudioTrust: Benchmarking the Multifaceted Trustworthiness of Audio Large Language Models](https://arxiv.org/abs/2505.16211) **Kai Li**, Can Shen, Yile Liu, Jirui Han, Kelong Zheng, Xuechao Zou, Zhe Wang, Shun Zhang, Xingjian Du, et al. **ICLR 2026. Rio de Janeiro, Brazil.**

- AudioTrust is a comprehensive multi-dimensional trustworthiness benchmark for audio large language models, spanning safety, privacy, fairness, robustness, hallucination, and authenticity.

- <a href="https://github.com/JusperLee/AudioTrust"><img src="https://img.shields.io/github/stars/JusperLee/AudioTrust?style=social&amp;label=Code+Stars" alt=""></a> \| [![AudioTrust Dataset](https://img.shields.io/badge/Huggingface-AudioTrust-orange?logo=huggingface)](https://huggingface.co/datasets/JusperLee/AudioTrust)

</div>
</div>

<div class='paper-box'><div class='paper-box-image'><div><div class="badge">ICLR 2026</div><img src='./images/dolphin.png' alt="sym" width="100%"></div></div>
<div class='paper-box-text' markdown="1">

[Efficient Audio-Visual Speech Separation with Discrete Lip Semantics and Multi-Scale Global-Local Attention](https://arxiv.org/abs/2509.23610) **Kai Li\***, Kejun Gao*, Xiaolin Hu. **ICLR 2026. Rio de Janeiro, Brazil.**

- Dolphin replaces dense lip features with discrete lip semantics and pairs them with multi-scale global-local attention for efficient and accurate audio-visual speech separation.

- [![Demo-Page](https://img.shields.io/badge/Demo_Page-Online-brightgreen)](http://cslikai.cn/Dolphin/) \| <a href="https://github.com/JusperLee/Dolphin"><img src="https://img.shields.io/github/stars/JusperLee/Dolphin?style=social&amp;label=Code+Stars" alt=""></a> \| [![HF Space](https://img.shields.io/badge/Huggingface-Space-orange?logo=huggingface)](https://huggingface.co/spaces/JusperLee/Dolphin) \| [![HF Model](https://img.shields.io/badge/Huggingface-Model-orange?logo=huggingface)](https://huggingface.co/JusperLee/Dolphin)

</div>
</div>

<div class='paper-box'><div class='paper-box-image'><div><div class="badge">TASLP 2026</div><img src='./images/solospeech.png' alt="sym" width="100%"></div></div>
<div class='paper-box-text' markdown="1">

[SoloSpeech: Enhancing Intelligibility and Quality in Target Speech Extraction through a Cascaded Generative Pipeline](https://arxiv.org/abs/2505.19314) Helin Wang, Jiarui Hai, Dongchao Yang, Chen Chen, **Kai Li**, Junyi Peng, Thomas Thebaud, Laureano Moro-Velázquez, Jesús Villalba, Najim Dehak. **IEEE Transactions on Audio, Speech and Language Processing (TASLP) 2026.**

- SoloSpeech is a cascaded generative pipeline that jointly enhances intelligibility and audio quality for target speech extraction.

- [![Demo-Page](https://img.shields.io/badge/Demo_Page-Online-brightgreen)](https://wanghelin1997.github.io/SoloSpeech-Demo/) \| <a href="https://github.com/wanghelin1997/solospeech"><img src="https://img.shields.io/github/stars/wanghelin1997/solospeech?style=social&amp;label=Code+Stars" alt=""></a> \| [![HF Space](https://img.shields.io/badge/Huggingface-Space-orange?logo=huggingface)](https://huggingface.co/spaces/OpenSound/SoloSpeech/) \| [![HF Model](https://img.shields.io/badge/Huggingface-Models-orange?logo=huggingface)](https://huggingface.co/OpenSound/SoloSpeech-models/)

</div>
</div>

<div class='paper-box'><div class='paper-box-image'><div><div class="badge">TGRS 2026</div><img src='./images/co2s.png' alt="sym" width="100%"></div></div>
<div class='paper-box-text' markdown="1">

[Toward Stable Semi-Supervised Remote Sensing Segmentation via Co-Guidance and Co-Fusion](https://xavierjiezou.github.io/Co2S/) Yi Zhou, Xuechao Zou, Shun Zhang, **Kai Li**, Shiying Wang, Jingming Chen, Congyan Lang, Tengfei Cao, Pin Tao, Yuanchun Shi. **IEEE Transactions on Geoscience and Remote Sensing (TGRS) 2026.**

- Co2S fuses VLM and SSM priors via a heterogeneous dual-student architecture (CLIP + DINOv3) with semantic co-guidance, mitigating pseudo-label drift and stabilizing semi-supervised remote sensing segmentation.

- [![Project-Page](https://img.shields.io/badge/Project_Page-Online-brightgreen)](https://xavierjiezou.github.io/Co2S/) \| <a href="https://github.com/XavierJiezou/co2s"><img src="https://img.shields.io/github/stars/XavierJiezou/co2s?style=social&amp;label=Code+Stars" alt=""></a> \| [![Co2S Dataset](https://img.shields.io/badge/Huggingface-Datasets-orange?logo=huggingface)](https://huggingface.co/datasets/XavierJiezou/co2s-datasets) \| [![Co2S Model](https://img.shields.io/badge/Huggingface-Models-orange?logo=huggingface)](https://huggingface.co/XavierJiezou/co2s-models)
...
[Dynamic Dictionary Learning for Remote Sensing Image Segmentation.](https://arxiv.org/abs/2503.06683) Xuechao Zou, Yue Li, Shun Zhang, **Kai Li**, Shiying Wang, Pin Tao, Junliang Xing, Congyan Lang. **ICCV 2025. Honolulu, Hawaii.**
